...
export default function TutorCatalog({ onSelectTutor }) {
  ...
  const defaultTutors = [
    ...
    },
    {
      ...
      gender: 'female',
      educationLevel: 'master',
      subjects: ['Ngữ văn', 'Luyện thi Lớp 10 / Chuyên', 'Luyện thi THPT'],
      bio: 'Giải Nhì Quốc gia môn Ngữ văn. Chuyên hướng dẫn phương pháp làm văn nghị luận sắc bén, rèn chữ và tư duy cảm thụ tác phẩm văn học.',
      verified: true,
    },
    {
      id: 6,
      ...
      gender: 'male',
      educationLevel: 'bachelor',
      subjects: ['Tin học / Lập trình', 'Toán học'],
      bio: 'Chuyên dạy Lập trình Python, Scratch, C++ cho học sinh cấp 2 & cấp 3, luyện thi học sinh giỏi Tin học và Tin học văn phòng quốc tế MOS.',
      verified: true,
    },
    {
      id: 7,
      fullName: 'Vũ Mai Anh',
      degree: 'Cử nhân Sư phạm Tiếng Nhật (JLPT N1)',
      ...
      gender: 'female',
      educationLevel: 'bachelor',
      subjects: ['Tiếng Nhật', 'Luyện thi IELTS / TOEIC'],
      bio: 'Từng du học trao đổi 2 năm tại Tokyo. Phương pháp phản xạ ngữ âm tự nhiên, luyện thi chứng chỉ JLPT từ N5 đến N2 nhanh chóng.',
      verified: true,
    },
    {
      id: 8,
      fullName: 'ThS. Nguyễn Tuấn Anh',
      degree: 'Thạc sĩ Lịch sử Thế giới',
      ...
      gender: 'male',
      educationLevel: 'master',
      subjects: ['Lịch sử', 'Địa lý', 'Luyện thi THPT'],
      bio: 'Biến môn Sử thành những câu chuyện sống động với sơ đồ timeline trực quan, kỹ thuật ghi nhớ nhanh các mốc sự kiện quan trọng.',
      verified: true,
    }
  ];
  ...
  const subjectsList = [
    ...
    { id: 'Luyện thi IELTS / TOEIC', label: 'Luyện thi IELTS / TOEIC' },
    { id: 'Vật lý', label: 'Vật lý' },
    { id: 'Hóa học', label: 'Hóa học' },
    { id: 'Sinh học', label: 'Sinh học' },
    { id: 'Lịch sử', label: 'Lịch sử' },
    { id: 'Địa lý', label: 'Địa lý' },
    { id: 'Tin học / Lập trình', label: 'Tin học / Lập trình' },
    ...
    { id: 'Luyện thi Lớp 10 / Chuyên', label: 'Luyện thi Lớp 10 / Chuyên' },
    { id: 'Rèn chữ đẹp & Tiếng Việt', label: 'Rèn chữ đẹp & Tiếng Việt' },
    { id: 'Toán tư duy Soroban', label: 'Toán tư duy Soroban' },
    { id: 'Âm nhạc / Nhạc cụ', label: 'Âm nhạc / Nhạc cụ' }
  ];
