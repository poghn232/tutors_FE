    ...
    const interval = setInterval(async () => {
      try {
        ...
        if (res && res.data && res.data.paid) {
          ...
          // Chuyển hướng sang trang kết quả sau 2s
          setTimeout(() => {
  ...
  const handleManualCheck = async () => {
    ...
    try {
      ...
      if (res && res.data && res.data.paid) {
        ...
        alert('Hệ thống đang chờ xác nhận từ ngân hàng. Nếu bạn vừa chuyển, vui lòng đợi 5-10 giây để SePay đồng bộ giao dịch.');
      }
    } catch (e) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          Giao dịch được bảo mật bởi SePay Webhook & Ngân hàng Quân Đội MB
        </div>
